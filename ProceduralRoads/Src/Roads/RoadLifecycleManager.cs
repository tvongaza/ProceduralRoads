...
public static class RoadLifecycleManager
{
    ...
    public static void OnPlayerSpawn(Vector3 spawnPoint)
    {
        ...
        {
            ProceduralRoadsPlugin.ProceduralRoadsLogger.LogDebug(forceRegenOnSpawn
                ? "ForceRegenerate set, regenerating roads..."
                : "No global road data, generating...");
            RoadNetworkGenerator.GenerateRoads(force: forceRegenOnSpawn);
        }
