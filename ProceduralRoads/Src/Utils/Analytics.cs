...
public static class Analytics
{
    ...
    public static void Init(ConfigFile config, string modId, string modVersion)
    {
        ...
        ConfigEntry<ProceduralRoadsPlugin.Toggle> enabled = config.Bind(
            "Analytics", "Enabled",
            ProceduralRoadsPlugin.Toggle.On,
        ...
        if (enabled.Value == ProceduralRoadsPlugin.Toggle.Off)
        {
            ProceduralRoadsPlugin.ProceduralRoadsLogger.LogDebug("Analytics disabled by config");
            return;
        }
    ...
    private static IEnumerator SendPing(string modId, string modVersion, string instanceId)
    {
        ...
        if (req.result == UnityWebRequest.Result.Success)
            ProceduralRoadsPlugin.ProceduralRoadsLogger.LogDebug("Analytics ping sent");
        else
            ProceduralRoadsPlugin.ProceduralRoadsLogger.LogDebug($"Analytics ping failed: {req.error}");
    }
