...
public static class ConsoleCommands
{
    ...
    public static void RegisterCommands()
    {
        ...
        new Terminal.ConsoleCommand(
            "road_bridges",
            "Bridges prototype: list the river crossings (bridges and fords) of the road network nearest to you (road_bridges [count=10]), " +
    ...
    private static void BridgesCommand(Terminal.ConsoleEventArgs args)
    {
        ...
        args.Context.AddString(
            ...
            $"{sites.Count} bridge site(s), {BridgePlans.TotalPlannedPieces} pieces planned across {BridgePlans.PlannedZoneCount} zone(s), {BridgePlans.SpawnedZones.Count} zone(s) spawned.");
        if (sites.Count == 0)
            return;
